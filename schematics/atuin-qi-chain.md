...
- Current file: `schematics/atuin-qi-chain.md`.
- Parent directory: `schematics`.
- Adjacent markdown siblings sampled: INDEX.md, anti-pattern-decision-tree.md, devops-v3-integration-flow.md, executor-verifier-sequence.md, layer-dag.md, module-graph.md, receipt-graph.md, runbook-awaiting-human-fsm.md.
