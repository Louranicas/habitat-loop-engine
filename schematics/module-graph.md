...
- Current file: `schematics/module-graph.md`.
- Parent directory: `schematics`.
- Adjacent markdown siblings sampled: INDEX.md, anti-pattern-decision-tree.md, atuin-qi-chain.md, devops-v3-integration-flow.md, executor-verifier-sequence.md, layer-dag.md, receipt-graph.md, runbook-awaiting-human-fsm.md.
