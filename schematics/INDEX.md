...
- [layer-dag](./layer-dag.md)
- [module-graph](./module-graph.md)
- [executor-verifier-sequence](./executor-verifier-sequence.md)
- [receipt-graph](./receipt-graph.md)
- [sqlite-er](./sqlite-er.md)
- [anti-pattern-decision-tree](./anti-pattern-decision-tree.md)
- [atuin-qi-chain](./atuin-qi-chain.md)
- [devops-v3-integration-flow](./devops-v3-integration-flow.md)
- [runbook-awaiting-human-fsm](./runbook-awaiting-human-fsm.md)
- [zellij-orchestrator-deployment-flow](./zellij-orchestrator-deployment-flow.md)
...
- Current file: `schematics/INDEX.md`.
- Parent directory: `schematics`.
- Adjacent markdown siblings sampled: anti-pattern-decision-tree.md, atuin-qi-chain.md, devops-v3-integration-flow.md, executor-verifier-sequence.md, layer-dag.md, module-graph.md, receipt-graph.md, runbook-awaiting-human-fsm.md.
