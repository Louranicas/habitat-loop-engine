...
- Markdown source remains human-authoritative until S13 tooling is implemented.
- Future JSONL substrate records must include parent SHA256 lineage.
- Every exported receipt must retain anchored fields.
- No execution PASS without round-trip verification.

## Comprehensiveness Review — Weaver 2026-05-10

### Purpose
This file is treated as a vault convention bridge within the Habitat Loop Engine deployment framework. Its purpose is to make the local-M0/scaffold surface legible to fresh agents without relying on unstated session memory.
...
- Current file: `vault/CONVENTIONS.md`.
- Parent directory: `vault`.
