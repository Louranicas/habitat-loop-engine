...
- module spec authored at `ai_specs/modules/c07-dispatch-bridges/M042_ATUIN_QI_BRIDGE.md`;
...
This module is part of the full end-to-end stack deployment chain: `CLAUDE.local.md -> README.md -> QUICKSTART.md -> MASTER_INDEX.md -> ULTRAMAP.md -> ai_docs/CLUSTERED_MODULES.md -> ai_specs/modules/c07-dispatch-bridges/M042_ATUIN_QI_BRIDGE.md -> this module sheet -> crates/hle-bridge/src/atuin_qi_bridge.rs`.

- Previous authority: `ai_docs/layers/L05_DISPATCH_BRIDGES.md` and `ai_docs/CLUSTERED_MODULES.md`.
- Spec authority: `ai_specs/modules/c07-dispatch-bridges/M042_ATUIN_QI_BRIDGE.md`.
- Source authority: `crates/hle-bridge/src/atuin_qi_bridge.rs`.
