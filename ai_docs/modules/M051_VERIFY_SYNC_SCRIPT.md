...
- module spec authored at `ai_specs/modules/c09-devops-qi-lane/M051_VERIFY_SYNC_SCRIPT.md`;
...
This module is part of the full end-to-end stack deployment chain: `CLAUDE.local.md -> README.md -> QUICKSTART.md -> MASTER_INDEX.md -> ULTRAMAP.md -> ai_docs/CLUSTERED_MODULES.md -> ai_specs/modules/c09-devops-qi-lane/M051_VERIFY_SYNC_SCRIPT.md -> this module sheet -> scripts/verify-sync.sh`.

- Previous authority: `ai_docs/layers/L06_CLI.md` and `ai_docs/CLUSTERED_MODULES.md`.
- Spec authority: `ai_specs/modules/c09-devops-qi-lane/M051_VERIFY_SYNC_SCRIPT.md`.
- Source authority: `scripts/verify-sync.sh`.
