# M001 SUBSTRATE_TYPES

Layer: L01
Crate: `crates/substrate-types`
Status: M0 local types.

## M0 local acceptance

- workflow, receipt, authorization, and error types exist;
...
- Previous authority: `L01_FOUNDATION.md` in `ai_docs/layers/` plus `ULTRAMAP.md`.
- Source authority: `crates/substrate-types/src/lib.rs`.
...
- Current file: `ai_docs/modules/M001_SUBSTRATE_TYPES.md`.
- Parent directory: `ai_docs/modules`.
- Adjacent markdown siblings sampled: INDEX.md, M002_SUBSTRATE_VERIFY.md, M003_SUBSTRATE_EMIT.md, M004_HLE_CLI.md.
