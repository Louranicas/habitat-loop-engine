...
- module spec authored at `ai_specs/modules/c08-cli-surface/M047_CLI_RUN.md`;
...
This module is part of the full end-to-end stack deployment chain: `CLAUDE.local.md -> README.md -> QUICKSTART.md -> MASTER_INDEX.md -> ULTRAMAP.md -> ai_docs/CLUSTERED_MODULES.md -> ai_specs/modules/c08-cli-surface/M047_CLI_RUN.md -> this module sheet -> crates/hle-cli/src/run.rs`.

- Previous authority: `ai_docs/layers/L06_CLI.md` and `ai_docs/CLUSTERED_MODULES.md`.
- Spec authority: `ai_specs/modules/c08-cli-surface/M047_CLI_RUN.md`.
- Source authority: `crates/hle-cli/src/run.rs`.
