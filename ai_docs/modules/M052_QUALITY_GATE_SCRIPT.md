...
- module spec authored at `ai_specs/modules/c09-devops-qi-lane/M052_QUALITY_GATE_SCRIPT.md`;
...
This module is part of the full end-to-end stack deployment chain: `CLAUDE.local.md -> README.md -> QUICKSTART.md -> MASTER_INDEX.md -> ULTRAMAP.md -> ai_docs/CLUSTERED_MODULES.md -> ai_specs/modules/c09-devops-qi-lane/M052_QUALITY_GATE_SCRIPT.md -> this module sheet -> scripts/quality-gate.sh`.

- Previous authority: `ai_docs/layers/L06_CLI.md` and `ai_docs/CLUSTERED_MODULES.md`.
- Spec authority: `ai_specs/modules/c09-devops-qi-lane/M052_QUALITY_GATE_SCRIPT.md`.
- Source authority: `scripts/quality-gate.sh`.
