# M002 SUBSTRATE_VERIFY

Layer: L04
Crate: `crates/substrate-verify`
Status: M0 local verifier.

## M0 local acceptance

- verifier authority gates runtime receipts;
...
- Previous authority: `L04_VERIFICATION.md; L07_RUNBOOK_SEMANTICS.md` in `ai_docs/layers/` plus `ULTRAMAP.md`.
- Source authority: `crates/substrate-verify/src/lib.rs`.
...
- Current file: `ai_docs/modules/M002_SUBSTRATE_VERIFY.md`.
- Parent directory: `ai_docs/modules`.
- Adjacent markdown siblings sampled: INDEX.md, M001_SUBSTRATE_TYPES.md, M003_SUBSTRATE_EMIT.md, M004_HLE_CLI.md.
