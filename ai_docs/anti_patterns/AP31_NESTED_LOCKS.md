...
- Current file: `ai_docs/anti_patterns/AP31_NESTED_LOCKS.md`.
- Parent directory: `ai_docs/anti_patterns`.
- Adjacent markdown siblings sampled: AP28_COMPOSITIONAL_INTEGRITY_DRIFT.md, AP29_BLOCKING_IN_ASYNC.md, C12_UNBOUNDED_COLLECTIONS.md, C13_MISSING_BUILDER.md, C6_LOCK_HELD_SIGNAL_EMIT.md, C7_LOCK_GUARD_REFERENCE_RETURN.md, FP_FALSE_PASS_CLASSES.md, INDEX.md.
