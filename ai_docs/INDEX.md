...
- [Code Module Map](CODE_MODULE_MAP.md)
- [Clustered Modules](CLUSTERED_MODULES.md)
- layers/
- modules/
- anti_patterns/
- use_patterns/
...
- Current file: `ai_docs/INDEX.md`.
- Parent directory: `ai_docs`.
- Adjacent markdown siblings sampled: CLUSTERED_MODULES.md, CODE_MODULE_MAP.md.
