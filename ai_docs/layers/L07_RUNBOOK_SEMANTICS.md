...
- Downstream module authority: `M002_SUBSTRATE_VERIFY + M003_SUBSTRATE_EMIT` in `ai_docs/modules/`.
- Downstream source authority: `crates/substrate-verify/src/lib.rs; crates/substrate-emit/src/lib.rs; runbooks/`.
...
Crates: substrate-verify (helper), substrate-emit (helper), hle-runbook.

Clusters touching this layer (per `ai_docs/CLUSTERED_MODULES.md`):

- C06 (M032-M039 runbook_schema/parser/phase_map/human_confirm/manual_evidence/scaffold/incident_replay/safety_policy)
...
- Current file: `ai_docs/layers/L07_RUNBOOK_SEMANTICS.md`.
- Parent directory: `ai_docs/layers`.
- Adjacent markdown siblings sampled: L01_FOUNDATION.md, L02_PERSISTENCE.md, L03_WORKFLOW_EXECUTOR.md, L04_VERIFICATION.md, L05_DISPATCH_BRIDGES.md, L06_CLI.md.
