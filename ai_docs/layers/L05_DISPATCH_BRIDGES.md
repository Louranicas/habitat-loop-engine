...
- Downstream module authority: `future bridge modules only` in `ai_docs/modules/`.
- Downstream source authority: `ai_specs/S09_DEVOPS_V3_READ_ONLY_INTEGRATION.md`.
...
- C07 (M040-M045 bridge_contract/zellij_dispatch/atuin_qi_bridge/devops_v3_probe/stcortex_anchor_bridge/watcher_notice_writer)
...
- Current file: `ai_docs/layers/L05_DISPATCH_BRIDGES.md`.
- Parent directory: `ai_docs/layers`.
- Adjacent markdown siblings sampled: L01_FOUNDATION.md, L02_PERSISTENCE.md, L03_WORKFLOW_EXECUTOR.md, L04_VERIFICATION.md, L06_CLI.md, L07_RUNBOOK_SEMANTICS.md.
