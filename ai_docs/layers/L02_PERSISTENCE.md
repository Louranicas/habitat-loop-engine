...
- Downstream source authority: `crates/substrate-emit/src/lib.rs; migrations/0001_scaffold_schema.sql`.
...
Crates: substrate-emit, hle-storage.

Clusters touching this layer (per `ai_docs/CLUSTERED_MODULES.md`):

- C01 (M007 receipts_store), C04 (M021 anti_pattern_events), C05 (M025-M031 pool/migrations/workflow_runs/workflow_ticks/evidence_store/verifier_results_store/blockers_store)
...
- Current file: `ai_docs/layers/L02_PERSISTENCE.md`.
- Parent directory: `ai_docs/layers`.
- Adjacent markdown siblings sampled: L01_FOUNDATION.md, L03_WORKFLOW_EXECUTOR.md, L04_VERIFICATION.md, L05_DISPATCH_BRIDGES.md, L06_CLI.md, L07_RUNBOOK_SEMANTICS.md.
