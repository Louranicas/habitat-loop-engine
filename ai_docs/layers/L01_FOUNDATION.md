...
- Downstream module authority: `M001_SUBSTRATE_TYPES` in `ai_docs/modules/`.
- Downstream source authority: `crates/substrate-types/src/lib.rs`.
...
Crates: substrate-types, hle-core.

Clusters touching this layer (per `ai_docs/CLUSTERED_MODULES.md`):

- C01 (M005 receipt_hash, M006 claims_store), C02 (M010 claim_authority, M011 workflow_state), C04 (M022 test_taxonomy)
...
- Current file: `ai_docs/layers/L01_FOUNDATION.md`.
- Parent directory: `ai_docs/layers`.
- Adjacent markdown siblings sampled: L02_PERSISTENCE.md, L03_WORKFLOW_EXECUTOR.md, L04_VERIFICATION.md, L05_DISPATCH_BRIDGES.md, L06_CLI.md, L07_RUNBOOK_SEMANTICS.md.
