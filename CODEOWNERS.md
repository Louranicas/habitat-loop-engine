...
* Luke / Weaver
/ai_specs/ Command-2 verification lane
/ai_docs/ Command-3 docs lane
/scripts/ Command-2 verification lane
/crates/ Command primary + Command-2
...
- Current file: `CODEOWNERS.md`.
- Parent directory: `.`.
- Adjacent markdown siblings sampled: ARCHITECTURE.md, CHANGELOG.md, CLAUDE.local.md, CLAUDE.md, HARNESS_CONTRACT.md, QUALITY_BAR.md, QUICKSTART.md, README.md.
