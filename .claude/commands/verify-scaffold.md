...
Run `scripts/quality-gate.sh --scaffold` and report exact failures.
...
- Current file: `.claude/commands/verify-scaffold.md`.
- Parent directory: `.claude/commands`.
- Adjacent markdown siblings sampled: scaffold-status.md.
