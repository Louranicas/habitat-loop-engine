...
description: Reviews scaffold-only coherence
tools: [Read, Bash]
---
Review scaffold coherence without adding M0 runtime behavior.
...
- Current file: `.claude/agents/scaffold-reviewer.md`.
- Parent directory: `.claude/agents`.
