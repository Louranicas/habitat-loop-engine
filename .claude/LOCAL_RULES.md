...
- no code beyond scaffold skeletons before M0
- executor cannot final PASS
- no live writes
- no destructive cleanup
- no unbounded output
- no sync I/O inside async runtime
- no duplicate runbook engine

## Comprehensiveness Review — Weaver 2026-05-10

### Purpose
This file is treated as a Claude/operator context surface within the Habitat Loop Engine deployment framework. Its purpose is to make the local-M0/scaffold surface legible to fresh agents without relying on unstated session memory.
...
- Current file: `.claude/LOCAL_RULES.md`.
- Parent directory: `.claude`.
- Adjacent markdown siblings sampled: PROJECT_CONTEXT.md.
