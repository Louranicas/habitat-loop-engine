...
- Current file: `docs/workflows/scaffold-workflow-kanban-closure.md`.
- Parent directory: `docs/workflows`.
- Adjacent markdown siblings sampled: scaffold-deployment-kanban-map.md, scaffold-deployment-mermaid.md, scaffold-deployment-workflow.md, scaffold-m0-broadening-review-20260510T112840Z.md.
