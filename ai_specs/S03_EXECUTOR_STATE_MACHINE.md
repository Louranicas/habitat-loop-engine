# S03 EXECUTOR STATE MACHINE

Status: scaffold spec shell.

## Authority

This file is part of the canonical S01-S13 scaffold inventory.

## Acceptance

- Present in `ai_specs/INDEX.md`.
- Referenced by scaffold verification.
- Local-M0 executor rejects blocked command tokens by command basename, including absolute or relative paths to blocked commands and separator-chained command words.
...
- Current file: `ai_specs/S03_EXECUTOR_STATE_MACHINE.md`.
- Parent directory: `ai_specs`.
- Adjacent markdown siblings sampled: INDEX.md, S01_SYSTEM_OVERVIEW_AND_AUTHORITY_BOUNDARY.md, S02_WORKFLOW_DEFINITION_MODEL.md, S04_VERIFIER_AND_RECEIPT_AUTHORITY.md, S05_PERSISTENCE_LEDGER_AND_SQLITE_SCHEMA.md, S06_CLI_AND_LOCAL_OPERATION_SURFACE.md, S07_ANTI_USE_PATTERN_INTELLIGENCE.md, S08_ATUIN_QI_VERIFICATION_CHAIN.md.
